...
# Dataset ESPECÍFICO para captchas grises

dataset, vocab, max_len = [], set(), 0
captcha_path = os.path.join("dataset_gris")
...
# Guardar este modelo en carpeta separada para no tocar el modelo de color
configs.model_path = "model_gris"
